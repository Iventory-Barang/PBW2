                ...
                <div class="col-md-5">
                    <div class="card-body" style="display: flex; align-items: center;">
                        ...
                        <div style="flex: 1; position: relative; margin-left: 50px;">
                            <input type="text" style="width: 300%; padding: 8px; border: 3px solid #fff; box-sizing: border-box; border-radius: 16px;">
                        </div>
                    </div>
                    <div class="card-body" style="display: flex; align-items: center;">
                    ...
                    <div class="card-body" style="display: flex; align-items: center;">
                        ...
                        <div style="flex: 1; position: relative; margin-left: 30px;">
                            <input type="text" style="width: 100%; padding: 8px; border: 3px solid #fff; box-sizing: border-box; border-radius: 16px;">
                        </div>
                    </div>
                    <div class="card-body" style="display: flex; align-items: center;">
