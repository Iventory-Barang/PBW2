        ...
        <div class="row d-flex" style="margin-top: 100px;">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row px-3">
                        <h3 class="mb-0 mr-4 mt-2 login-text">LOGIN</h3> <!-- Ganti "Sign in" menjadi "LOGIN" dan atur warna huruf -->
                    </div>
                   <hr>
                   <div>
            ...
            @endif
                ...
                <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account?
                     <a class="text-danger" href="http://localhost/TubesPBW/public/register">Register</a></small> </div>
                </div>
            </div>
            </form>
        </div>
